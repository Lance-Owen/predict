...
df2 = df[df['取值范围']=='0.5-15']
df2 = df2[['zbkzj','年', '月', '日', '时', '分', pre_label]]
df2 = df2.fillna(-999)
print(record_predict(df2,[8605491.13,2023,8,10,8,30],4))
print(record_predict(df2,[8605491.13,2023,8,10,8,30],3))
print(record_predict(df2,[8605491.13,2023,8,10,8,30],2))
print(record_predict(df2,[8605491.13,2023,8,10,8,30],1))

# print(record_predict(df2,[9673409.49,2022,8,25,9,0],degree))


df3 = df[df['取值范围'].str.contains('98-102')]
# df3 = df[df['取值范围']=='98-102']
df3 = df3[['zbkzj','年', '月', '日', '时', '分', pre_label]]
df3 = df3.fillna(-999)
# print(record_predict(df3,[3606839.92,2023,8,24,10,0],degree))
